...
wcss = []
# "n_init": Inicializacion aleatoria
for i in range(1, 11):
...
# "y_kmeans": un array con el nro_de_cluster al que pertenece cada dato


# Visualización de los clusters(de cada uno que estan catalogados como: 0-1-2-3-4)
# "s = 100/tamaño_del_punto, c = "red", label = "Cautos" " :caracteristicas del punto
