...
# Los arboles no usan escalado, no usan distancias(se usa ENTROPIA)
...
y_pred = predict(classifier, newdata = testing_set[,-3],
                 type = "class")
# Si no tienen type = "class"// Me dara las probabilidades de ser cada clase. Con el "type..." me delvuelve la clase
